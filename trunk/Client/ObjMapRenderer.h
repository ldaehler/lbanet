...
#if !defined(__LbaNetModel_1_ObjMapRenderer_h)
#define __LbaNetModel_1_ObjMapRenderer_h
 ...
 ***********************************************************************/
class ObjMapRenderer : public MapRendererBase
{
public:
	//! constructor
	ObjMapRenderer(const std::string &objfilename, const std::string &texturefilename);

	//! destructor
	virtual ~ObjMapRenderer();
