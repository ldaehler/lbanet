...
constructor
***********************************************************/
LBA_MAP::LBA_MAP(int n,bool LBA2)
{
	...
	// add shape to the invisible walls so that twinsen can not fall down
	//for(i=0;i<64;i++)
 //   for(j=0;j<64;j++)
 //   {
	//	if(grid->info_brick[i][j][0].index_brick == 0)
	//	{
	//		int idxnotempty = -1;
	//		for(k=1;k<25;k++)
	//		{
	...
	if(LBA2)
		filename << "Data/Maps/Lba2/";
	else
		filename << "Data/Maps/Lba1/";
	filename << "map" << n << ".txt";
