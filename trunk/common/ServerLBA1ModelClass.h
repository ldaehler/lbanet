...
#ifndef ServerLBA1ModelClassH
#define ServerLBA1ModelClassH
...
public:
	...
	ServerLBA1ModelClass(entitiesTableStruct* entitiesData, const std::string &bodyPath, const std::string &animPath, int entityNum=0,int bodyNum=0);
	~ServerLBA1ModelClass();
