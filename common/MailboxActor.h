...
#if !defined(__LbaNetModel_1_MailboxActor_h)
#define __LbaNetModel_1_MailboxActor_h

#include "ActivableActor.h"


/***********************************************************************
 * Module:  MailboxActor.h
 * Author:  vivien
 * Modified: lundi 27 juillet 2009 14:53:50
 * Purpose: Declaration of the class Actor
 *********************************************************************/
class MailboxActor : public ActivableActor
{
public:
	//! constructor
	MailboxActor(float activationdistance, int activationtype);
